...
<?php require './header_footer/customer_header.php' ?>
    ...
    ?>
        ...
        <div class="container" id="cont" style="margin-top: 150px">
            <div class="row">
                        ...
                        <table class="table text-center">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">
                                        <form action="_manageCart.php" method="POST">
                                            ...
                                            <input type="hidden" name="customerId" value="<?php $customer_id = $_SESSION['customer_id'];
                                                                                        echo $customer_id ?>">
                                        </form>
                                    </th>
                                </tr>
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    $mysql = "SELECT * FROM `menu` WHERE food_Id = $foodId";
                                    $myresult = mysqli_query($conn, $mysql);
                                    $myrow = mysqli_fetch_assoc($myresult);
                                    $foodName = $myrow['food_name'];
                                    $foodPrice = $myrow['price'];
    ...
    <?php
        ...
        <div class="alert alert-info my-3">
            <font style="font-size:22px"><center>Before checkout you need to <strong>Login</strong></center></font>
        </div></div>';
    }
    ?>
