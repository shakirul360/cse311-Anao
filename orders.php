...
include './header_footer/customer_header.php';
    ...
    <div class="table-wrapper" id="empty">
        ...
        <table class="table table-striped table-hover text-center">
            ...
            <tbody>
                ...
                if ($numRows == 0) {
                    echo '<tr><td colspan="9"><div class="alert alert-info alert-dismissible fade show" role="alert" style="width:100%">You have not placed any orders!</div></td></tr>';
                } else {
...
<?php
    ...
    echo '<div class="container" style="min-height: 610px;">
        <div class="alert alert-info my-3">
            <font style="font-size:22px"><center>You need to <strong><a class="alert-link" href="login.php">Login</a></strong> or <strong><a class="alert-link" href="signup.php">Signup</a></strong> before viewing the order page</center></font>
        </div>
    </div>';
}
